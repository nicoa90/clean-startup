...
namespace Domain.Core.Abstractions.Results
{
    ...
    public class Result
    {
        ...
        public static Result<TValue> Success<TValue>(TValue value) => new Result<TValue>(value, true, DomainError.None);
        ...
        public static Result<TValue> Create<TValue>(TValue value, DomainError error)
            where TValue : class
        ...
        /// </remarks>
        public static Result<TValue> Failure<TValue>(DomainError error) => new Result<TValue>(default!, false, error);
